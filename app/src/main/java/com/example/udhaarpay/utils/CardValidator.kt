...
import com.example.udhaarpay.data.model.CardType
...
object CardValidator {
    ...
    fun getCardType(cardNumber: String): CardType {
        ...
        return when {
            ...
            sanitized.startsWith("5") -> CardType.MASTERCARD
            sanitized.startsWith("3") -> CardType.AMEX
            isValidRuPayCard(cardNumber) -> CardType.RUPAY
            else -> CardType.RUPAY // Default
        }
    }
